...
- Block height manipuration. Developpers can forward and revert blocks via RPC.
...
## Block height manipuration
Developpers can forward blocks and revert blocks to requested block heights.
...
When blocks' states are pruned, RPC won't revert finalzied blocks.
